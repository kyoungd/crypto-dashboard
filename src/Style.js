...
export const subtleGreenBoxShadow = `box-shadow: 0px 0px 5px 1px ${lightTheme ? '#a9b6ff' : '#323d7b'}`;
export const greenBoxShadow = `box-shadow: 0px 0px 4px 2px #5fff17`;
export const greenLightBoxShadow = `box-shadow: 0px 0px 4px 2px #5fffe7`;
